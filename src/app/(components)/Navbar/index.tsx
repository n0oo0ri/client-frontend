    ...
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="relative">
        <input
          ...
          className="pl-10 pr-4 py-2 w-50 md:w-60 border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400"
        />
